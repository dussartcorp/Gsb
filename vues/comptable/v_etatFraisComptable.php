    ...
    <div class="row">
      <form action="index.php?uc=etatFraisComptable&action=modifierElementFicheHorsFrais" 
        ...
        <fieldset>
                  ...
                  foreach ($lesFraisHorsForfait as $unFraisHorsForfait) {
                    ...
                    <tr>
                      ...
                      <td><a href="index.php?uc=gererFraisComptable&action=supprimerFrais&idFrais=<?php echo $id ?>" 
                        ...
                        <a href="index.php?uc=gererFraisComptable&action=supprimerFrais&idFrais=<?php echo $id ?>" 
          ...
          <div>Nombre de justificatifs : <input type="text" id="nbjustificatifs" value=0></div>
          <br>
